...
public class MyBoardDAO {
	...
	public List<MyBoardVO> selectMyBoardList(MyBoardPagingDTO myBoardPagingDTO) throws DataAccessException {
		...
		List<MyBoardVO> articlesList = sqlSession.selectList("MyBoardMapperDAO.selectMyBoardListDAO", myBoardPagingDTO);
		return articlesList;
	}
    ...
    public Long selectRowAmountTotal(MyBoardPagingDTO myBoardPagingDTO) {
    	...
    	return sqlSession.selectOne("MyBoardMapperDAO.selectRowAmountTotalDAO", myBoardPagingDTO);
    };
